...
class BigQuery(object):
    ...
    def most_popular_overall(self):
        """
        Live data commented out to save money on account
        """
        ##standardSQL
    ...
    def most_popular_day(self):
        ...
        ##standardSQL
        #SELECT day, sensor_name, AVG(hourly_counts) AS sum
        #FROM `s3462344-a1-lt11.ped_data.ped_data_small`
        #GROUP BY day, sensor_name
        #ORDER BY(sum) DESC
        #LIMIT 1;
        #""")
        #
        ...
        most_pop_day = []
        pop = {
                'sensor_name': 'Flinders St Swanston St',
                'count': '2547',
                'day': 'Sunday'
            }
    ...
    def most_popular_time(self):
        ...
        #query_job = client.run_async_query(str(uuid.uuid4()), """
        ##standardSQL
        #SELECT time, sensor_name, sum(hourly_counts) AS sum
        #FROM `s3462344-a1-lt11.ped_data.ped_data_small`
        #GROUP BY time, sensor_name
        #ORDER BY(sum) DESC
        #LIMIT 1;
        #""")
        ...
        #time = most_pop[0]['time']
        #if time > 12:
        #    time = str(time - 12) + ":00 PM"
        #if time <= 12:
        #    time = str(time) + ":00 AM"
        most_pop_time = []
        pop = {
    ...
    def most_popular_month(self):
        ...
        #query_job = client.run_async_query(str(uuid.uuid4()), """
        ##standardSQL
        #SELECT month, sensor_name, sum(hourly_counts) AS sum
        #FROM `s3462344-a1-lt11.ped_data.ped_data_small`
        #GROUP BY month, sensor_name
        #ORDER BY(sum) DESC
        #LIMIT 1;
        #""")
        ...
        most_pop_month = []
        pop = {
                'sensor_name': 'Flinders La Swanston St',
                'count': '1504540',
                'month': 'July'
            }
    ...
    def get_average_daily(self):
        ...
        #FROM `s3462344-a1-lt11.ped_data.ped_data_large`
        #GROUP BY sensor_name
        #ORDER BY(sum) DESC;
        #""")
        ...
        #destination_table = query_job.destination
        #destination_table.reload()
        #print destination_table.fetch_data()
